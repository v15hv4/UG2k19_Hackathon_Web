...
class TerminalWindow extends Component {
    ...
    render() { 
        return (
            <React.Fragment>
            <div style={{ height: "100vh", backgroundColor: this.state.bg_color }}>
            <div className='TerminalWindow container-fluid m-0 p-0'>
                ...
                <div className={"text-center " + (this.state.intro_hidden ? "d-none" : "")}>
                    ...
                    The duration is from 0800 hours on 23rd May to 2000 hours on 24th May, with a presentation by each team.
                    </div>
                    <div className="pt-4">
